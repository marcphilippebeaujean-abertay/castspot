...
export default () => (
  <div>
    ...
    <section>
      ...
      <h3>Cantact Data</h3>
      <p>
        Users of Castspot can share their contact data with others, upon
        explicitly agreeing with others to do so. This data is treated like any
        other user data, except that Marc Philippe Beaujean is not responsible
        with how this data is processed, stored, or used by other users that it
        was shared with.
      </p>
