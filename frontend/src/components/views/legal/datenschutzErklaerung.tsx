...
export default () => (
  <div>
    ...
    <section>
      ...
      <h3>Kontaktdaten Einwilligungserklärung</h3>
      <p>
        Nutzer können über den Dienst Kontaktdaten mit anderen Nutzern teilen,
        wofür Sie zuerst einwilligen müssen. Diese Daten werden wie andere Daten
        auch behandelt, Marc Philippe Beaujean trägt jedoch keine Verantwortung
        dafür, wie andere Nutzer diese Kontaktdaten bearbeiten, gebrauchen oder
        speichern, nachdem sie mit ihnen geteilt wurden.
      </p>
